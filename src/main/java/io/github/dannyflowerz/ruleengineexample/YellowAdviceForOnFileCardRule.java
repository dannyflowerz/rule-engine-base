 ...
 *
 */
public class YellowAdviceForOnFileCardRule extends Rule<DigitizedCard, Decision> {

	YellowAdviceForOnFileCardRule(JNDIUtil util) {
		super(util);
	}
	...
	public boolean isApplicable(DigitizedCard input) {
        return input.getTokenizationRecommendation() != null &&
                ...
                PansourceType.CardOnFile.equals(input.getPanSource());
	}
